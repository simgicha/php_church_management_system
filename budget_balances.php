            ...
            <div class="portlet-body form">
                <div class="tabbable-custom ">
                    ...
                    <div class="tab-content">
                        This list shows all the budgets registred in the system. To view the balances on each budget, select and view details
                        
<?php
	include('connect-db.php');

         $result = mysqli_query($connection,"SELECT b.id, b.ref_no, b.description FROM budget_ref b") 
		...
		<td bgcolor=\"#E6E6E6\"><strong>Budget No</strong></td>	
	...
	echo "<tr>";
		...
		echo "<td align='center' bgcolor='#F3F3F3'>";echo $rows['ref_no']; echo "</td>";
		echo "<td align='center' bgcolor='#FFFFFF'>";echo $rows['description']; echo "</td>";

		echo "<td align='center' bgcolor='#FFFFFF'>";echo "<a href='budget_balances_details.php?id=$id'>View Details</a>"; echo "</td>";
	echo "</tr>	";
	}	
	echo "</table>";	
 ?>
