                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                          <a href="church_select.php"><button type="button" class="btn btn-primary">+ Add New Member</button></a>
                        </div>
                                          ...
                                          <?php
                                            ...
                                            { // Start looping table row
                                              ...
                                              //echo $rows['id']." ".$rows['full_name'];
                                                ...
                                                echo "<td>".$rows['local_church_name']."</td>";
                                                echo "<td>".$rows['scc_name']."</td>";
                                                echo "<td>".$rows['marital_status']."</td>";
                                                echo "<td>".$rows['phone_number']."</td>";
                                                echo "<td>".$rows['registration_date']."</td>";
                                                                     
                                                echo "<td align='center' bgcolor='#FFFFFF'>";echo "<a href='member-edit.php?id=$id'>Edit/Delete</a>"; echo "</td>";
                                                echo "</tr>";
                                          }
