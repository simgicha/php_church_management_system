...
<?php include("top.php"); ?>
            ...
            <div class="portlet-body form">
                <div class="tabbable-custom ">
                    ...
                    <div class="tab-content">
                        <b><h2>Individual Tithes Contribution with Amount</h2></b>.
                        ...
                        <br>Please select the Local Church and the tithe to view individual contribuitions
                            ...
                            <form name = "members-tithes" id="members-tithes" action="tithes-individual-view-local-church-amount.php" method="post">        
 ...
 <!-- &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& end form &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& -->  
<br><br>
You can view all the tithes for all local churches at once
<!-- ppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppp -->
                             <form name = "members-tithes-amoint" id="members-tithes-amount" action="tithes-all-amount.php" method="post">        
                      <table  class="alert-table" cellspacing="0" cellpadding="4" width="100%" border="0" id="my-editor" >
                    ...
                    or die("No Buildings are added");  
                      ...
                      ?>
                                        ...
                                        <td align="right" border="0">
                                              <span class="input-group-btn"><br>
                                                    <input type="submit" class="btn green" value="View All Records At Once"  >
  ...
  <script  type="text/javascript">
 var frmvalidator = new Validator("members-tithes-amount");
