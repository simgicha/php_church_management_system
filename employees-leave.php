           ...
           <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <div class="tabbable-custom ">
                    ...
                    This section us used to indicate when an employee takes on a leave. indicate the start date and the number of leave days taken<br>
<!-- &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& form &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& -->
                                     <style>
                                   ...
                                   Select on a member to view leave days
                            ...
                            <?php		
								if(!isset($_POST['employee_name'])){
									...
									include('connect-db.php');
									 ...
									 $result = mysqli_query($connection,"SELECT l.id, e.employee_name, COALESCE(SUM(l.no_of_days),0) as no_of_days, COALESCE(SUM(leave_days_awarded),0) as days_awarded from employee_leave_days l, employees e WHERE e.id = l.employee_id AND l.employee_id = '".$employee_id."' ORDER BY l.id DESC") 
									...
									echo "	<tr>
										...
										<td width=\"10%\" align=center bgcolor=\"#E6E6E6\"><strong>Total leave days taken</strong></td>
										<td width=\"10%\" align=center bgcolor=\"#E6E6E6\"><strong>leave days awarded</strong></td>
										<td width=\"10%\" align=center bgcolor=\"#E6E6E6\"><strong>Leave days balance</strong></td>
									...
									?>
                                        <tr>
											...
											<td align="center" bgcolor="#FFFFFF"><?php {echo $rows['days_awarded']; }?></td>
                                            <td align="center" bgcolor="#FFFFFF"><?php {echo ($rows['days_awarded']-$rows['no_of_days']); }?></td>
                                        </tr>
                                     <?php 
									}
									echo "</table>";
...
$(document).ready(function () {
	...
	var categAssingModel = kendo.data.Model.define({
		...
		fields: { 				
			...
			no_of_days: {type: "string", validation: { required: true } },
    ...
    $('#leave_days_grid').kendoGrid({
        ...
        columns: [
			...
			{ field: "no_of_days", title:"No of days taken"},
			{ field: "reason", title:"Reason for leave if any"},	
