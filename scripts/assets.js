$(document).ready(function () {
	...
	var assetsModel = kendo.data.Model.define({
		...
		fields: { 
			...
			item_category_id:{type: "string", validation: { required: false } },
    ...
    $('#assetsgrid').kendoGrid({
        ...
        columns: [
			...
			{ field: "item_category_id", title:"Item category", width: "120px",editor: itemCategoryDropDownEditor,template: "#= category_name #"  },			   
			{ command: ["edit", "destroy"], title: "&nbsp;", width: "150px" }
		],
        toolbar: [{ name: "create", text: "Add New Asset" }], 
		...
		$('<input required data-text-field="category_name" data-value-field="id" data-bind="value:' + options.field + '"/>')
			...
			.kendoDropDownList({
				...
				dataSource:{
					...
					transport: {
						read: {
							url:"data/get_asset_categories.php",
							type: "GET",
							dataType: "json",
						}
					}
